...
export default function RegisterPage() {
  ...
  <div className="flex items-center justify-center">
    <div className="bg-white w-full max-w-md rounded-lg shadow-md p-8">
        <h1 className="text-2xl font-bold mb-2 text-center text-[#003049]">Create an Account</h1>
        <p className="text-center text-gray-500 mb-6">Join WholesaleHub today</p>

        {serverError && (
          <p className="bg-red-100 text-red-700 text-sm p-2 rounded mb-4">{serverError}</p>
        )}
        {successMessage && (
          <p className="bg-green-100 text-green-700 text-sm p-2 rounded mb-4">{successMessage}</p>
        )}
          ...
          <div>
            <label className="flex items-start gap-2 text-sm text-gray-700">
              ...
              <span>
                ...
                and{" "}
                <Link to="/privacy" className="text-[#f77f00] hover:underline">
                  Privacy Policy
                </Link>
              </span>
            </label>
        ...
        <p className="text-sm text-center mt-4 text-gray-600">
          ...
          <Link to="/login" className="text-[#f77f00] font-medium hover:underline">
            Sign In
          </Link>
        </p>
      </div>
