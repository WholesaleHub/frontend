...
export default function ProductFormPage() {
  ...
  async function handleAddCategory() {
    if (!token || !newCategoryName.trim() || isAddingCategory || isSubmitting) {
      return;
    }
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const fields = {
      ...
      remove_image: isEditMode && removeExistingImage ? true : undefined,
    };
        ...
        >
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 border rounded-lg text-sm text-[#f77f00] border-[#f77f00]"
                >
                  +
                </button>
              </div>
              {showNewCategory && (
                <div className="flex gap-2 mt-2">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-[#003049] px-3 text-sm text-white disabled:cursor-not-allowed disabled:bg-gray-300"
                  >
          ...
          <div>
            ...
            <label className="border-2 border-dashed rounded-lg flex flex-col items-center justify-center text-center p-6 cursor-pointer hover:bg-gray-50">
              ...
              <span className="text-sm text-[#f77f00] font-medium mt-1">
                Choose File
              </span>
              <input
                type="file"
          ...
          <div className="md:col-span-3 flex justify-end gap-2 pt-2 border-t">
            ...
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-medium bg-[#f77f00] text-white hover:bg-[#d62828] disabled:bg-gray-300"
            >
