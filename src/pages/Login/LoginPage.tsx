...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const userRole = data.user.role.toUpperCase() as UserRole;
      ...
      const defaultDashboard = `/dashboard/${userRole.toLowerCase()}`;
      ...
      const requestedPathMatchesRole =
        requestedPath?.startsWith(`/dashboard/${userRole.toLowerCase()}`) ||
      ...
      navigate(
        requestedPath && requestedPathMatchesRole
